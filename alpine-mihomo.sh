...
bash <(curl -fsSL https://github.com/mi1314cat/One-click-script/raw/refs/heads/main/alpine-nginx.sh)
...
vmess://$UUID@$link_ip:$Vmess_port?encryption=none&allowInsecure=1&type=ws&path=${WS_PATH}#vmess
